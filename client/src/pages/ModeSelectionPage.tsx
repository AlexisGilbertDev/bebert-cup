  ...
  return (
    <div className="msb-page">
      ...
      <div className="msb-hero">
        ...
        />
        <div className="msb-hero-tab" aria-hidden="true">
          NANKATSU SC
        </div>
      </div>
      ...
      <div className="msb-cards">
        <button
          type="button"
          className="msb-card"
          onClick={() => navigate('/survivor/setup')}
        >
          ...
          <span className="msb-pill msb-pill--red" aria-hidden="true">
            JOUER ›
          </span>
        </button>
        ...
        >
          <div className="msb-card-top">
            ...
            <div className="msb-vs-badge" aria-hidden="true">
              VS
            </div>
          </div>
          <p className="msb-card-desc">
          ...
          <span className="msb-pill msb-pill--blue" aria-hidden="true">
            JOUER ›
          </span>
        </button>
        ...
        <button
          type="button"
          className="msb-card"
          onClick={() => navigate('/team-play/setup')}
        >
          <div className="msb-card-top">
            ...
            <div className="msb-team-badge" aria-hidden="true">
              ...
              >
                ...
                <rect x="3" y="17" width="8" height="10" rx="2" />
                <circle cx="14" cy="13" r="3.5" />
                <rect x="10" y="17" width="8" height="10" rx="2" />
                <circle cx="26" cy="13" r="3.5" />
                <rect x="22" y="17" width="8" height="10" rx="2" />
                <circle cx="33" cy="13" r="3.5" />
                <rect x="29" y="17" width="8" height="10" rx="2" />
              </svg>
            </div>
          </div>
          <p className="msb-card-desc">
          ...
          <span className="msb-pill msb-pill--green" aria-hidden="true">
            JOUER ›
          </span>
        </button>
      </div>
